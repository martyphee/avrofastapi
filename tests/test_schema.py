...
@pytest.mark.parametrize(
    ...
    [
        (
            BasicModelBaseTypes,
            {
                "namespace": "BasicModelBaseTypes",
                "name": "BasicModelBaseTypes",
                "type": "record",
                "fields": [
                    {"name": "A", "type": "string"},
                    {"name": "B", "type": "long"},
        ...
        (
            BasicModelAdvancedTypes,
            {
                "namespace": "BasicModelAdvancedTypes",
                "name": "BasicModelAdvancedTypes",
                "type": "record",
                "fields": [
                    {
                        "name": "A",
                    ...
                    {
                        "name": "B",
                        "type": {"name": "Bytes_10", "type": "fixed", "size": 10},
                    },
                    {
                        "name": "C",
                        "type": {
                    ...
                    {"name": "E", "type": {"type": "int", "logicalType": "date"}},
                    {
                        "name": "F",
        ...
        (
            NestedModelBasicTypes,
            {
                "namespace": "NestedModelBasicTypes",
                "name": "NestedModelBasicTypes",
                "type": "record",
                "fields": [
                    {
                        "name": "A",
        ...
        (
            BasicModelTypingTypes,
            {
                "namespace": "BasicModelTypingTypes",
                "name": "BasicModelTypingTypes",
                "type": "record",
                "fields": [
        ...
        (
            BasicModelCustomNamespace,
            {
                "namespace": "custom.namespace",
                "name": "BasicModelCustomNamespace",
                "type": "record",
                "fields": [{"name": "A", "type": "long"}],
            },
        ),
        (
            BasicModelCustomNestedNamespace,
            {
                "namespace": "custom",
                "name": "BasicModelCustomNestedNamespace",
                "type": "record",
                "fields": [
                    {
                        "name": "A",
        ...
        (
            BasicModelDefaultValues,
            {
                "namespace": "BasicModelDefaultValues",
                "name": "BasicModelDefaultValues",
                "type": "record",
                "fields": [
                    {"name": "A", "type": "string", "default": "1"},
                    {"name": "B", "type": "long", "default": 2},
                    {"name": "C", "type": "double", "default": 3.1},
                    {"name": "D", "type": "bytes", "default": b"abc"},
                    {"name": "E", "type": "boolean", "default": True},
                ],
            },
        ),
        (
            BasicModelCustomTypes,
            {
                "namespace": "BasicModelCustomTypes",
                "name": "BasicModelCustomTypes",
                "type": "record",
                "fields": [
                    {"name": "A", "type": "int"},
                    {"name": "B", "type": "float"},
...
def test_ConvertSchema_ValidInputError_ModelConvertedSuccessfully(
    input_model: Type[BaseModel], expected: dict
):
...
def test_ConvertSchema_ValidInputError_ErrorModelConvertedSuccessfully(
    input_model: Type[BaseModel], expected: dict
):
...
def test_ConvertSchema_InvalidModel_ConvertSchemaThrowsError(
...
def test_ConvertSchema_HandshakeModels_HandshakeConvertedSuccessfully(
    input_model: Type[BaseModel], expected: dict
):
